"""F007 — pin public documents by digest (forward track: acquisition is not the
irreversible boundary, publication is; everything read is nonetheless pinned).

usage: pin.py <manifest-name> name=url [name=url ...]
Journals under data/raw/forward-f007/<manifest-name>/; manifest copied to
...
def main() -> int:
    ...
    raw = REPO_ROOT / "data/raw/forward-f007" / batch
